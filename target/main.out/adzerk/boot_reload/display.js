...
return (function (p__8686){
var vec__8687 = p__8686;
var attr = cljs.core.nth.call(null,vec__8687,(0),null);
var v = cljs.core.nth.call(null,vec__8687,(1),null);
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,attr)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(":"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),cljs.core.str.cljs$core$IFn$_invoke$arity$1(";")].join('');
});})(rules__$1))
;
...
var args8690 = [];
var len__8224__auto___8693 = arguments.length;
var i__8225__auto___8694 = (0);
while(true){
if((i__8225__auto___8694 < len__8224__auto___8693)){
args8690.push((arguments[i__8225__auto___8694]));

var G__8695 = (i__8225__auto___8694 + (1));
i__8225__auto___8694 = G__8695;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args8690.length)].join('')));
...
var len__8224__auto___8698 = arguments.length;
var i__8225__auto___8699 = (0);
while(true){
if((i__8225__auto___8699 < len__8224__auto___8698)){
args__8231__auto__.push((arguments[i__8225__auto___8699]));

var G__8700 = (i__8225__auto___8699 + (1));
i__8225__auto___8699 = G__8700;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq8697){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8697));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__8701){
var map__8705 = p__8701;
...
var data = map__8705__$1;
var message = cljs.core.get.call(null,map__8705__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8705__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8705__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8707 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__8707,goog.events.EventType.CLICK,((function (G__8707,map__8705,map__8705__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8707,map__8705,map__8705__$1,data,message,line,file))
);

return G__8707;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__8708){
var map__8712 = p__8708;
var map__8712__$1 = ((((!((map__8712 == null)))?((((map__8712.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8712.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8712):map__8712);
var data = map__8712__$1;
var message = cljs.core.get.call(null,map__8712__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__8712__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__8712__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__8714 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str.cljs$core$IFn$_invoke$arity$1("at line "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__8714,goog.events.EventType.CLICK,((function (G__8714,map__8712,map__8712__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__8714,map__8712,map__8712__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__8715){
var map__8719 = p__8715;
...
var messages = map__8719__$1;
var warnings = cljs.core.get.call(null,map__8719__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8719__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__8721 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__8721,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__8721,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__8722){
...
var messages = map__8725__$1;
var warnings = cljs.core.get.call(null,map__8725__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__8725__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__8725,map__8725__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__8725,map__8725__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__8725,map__8725__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__8725,map__8725__$1,messages,warnings,exception))
;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1("boot-reload-hud-"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.name.call(null,cljs.core.gensym.call(null)))].join('');
});
