...
return (function (p__7771){
var vec__7772 = p__7771;
var attr = cljs.core.nth.call(null,vec__7772,(0),null);
var v = cljs.core.nth.call(null,vec__7772,(1),null);
...
var args7773 = [];
var len__7480__auto___7776 = arguments.length;
var i__7481__auto___7777 = (0);
while(true){
if((i__7481__auto___7777 < len__7480__auto___7776)){
args7773.push((arguments[i__7481__auto___7777]));

var G__7778 = (i__7481__auto___7777 + (1));
i__7481__auto___7777 = G__7778;
continue;
} else {
}
break;
...
var len__7480__auto___7781 = arguments.length;
var i__7481__auto___7782 = (0);
while(true){
if((i__7481__auto___7782 < len__7480__auto___7781)){
args__7487__auto__.push((arguments[i__7481__auto___7782]));

var G__7783 = (i__7481__auto___7782 + (1));
i__7481__auto___7782 = G__7783;
continue;
} else {
}
break;
...
var argseq__7488__auto__ = ((((0) < args__7487__auto__.length))?(new cljs.core.IndexedSeq(args__7487__auto__.slice((0)),(0))):null);
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__7488__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq7780){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq7780));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__7784){
var map__7788 = p__7784;
var map__7788__$1 = ((((!((map__7788 == null)))?((((map__7788.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7788.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7788):map__7788);
var data = map__7788__$1;
var message = cljs.core.get.call(null,map__7788__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7788__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7788__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__7790 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__7790,goog.events.EventType.CLICK,((function (G__7790,map__7788,map__7788__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7790,map__7788,map__7788__$1,data,message,line,file))
);

return G__7790;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__7791){
var map__7795 = p__7791;
var map__7795__$1 = ((((!((map__7795 == null)))?((((map__7795.cljs$lang$protocol_mask$partition0$ & (64))) || (map__7795.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__7795):map__7795);
var data = map__7795__$1;
var message = cljs.core.get.call(null,map__7795__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__7795__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__7795__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
goog.events.listen(G__7797,goog.events.EventType.CLICK,((function (G__7797,map__7795,map__7795__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__7797,map__7795,map__7795__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__7798){
var map__7802 = p__7798;
...
var messages = map__7802__$1;
var warnings = cljs.core.get.call(null,map__7802__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7802__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__7804 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__7804,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__7804,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__7805){
var map__7808 = p__7805;
...
var messages = map__7808__$1;
var warnings = cljs.core.get.call(null,map__7808__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__7808__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__7808,map__7808__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__7808,map__7808__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__7808,map__7808__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__7808,map__7808__$1,messages,warnings,exception))
;
...
}catch (e7811){if((e7811 instanceof Error)){
var __7812 = e7811;
} else {
throw e7811;
